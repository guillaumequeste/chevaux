    ...
    return (
      <div>
        ...
        <div className="accueil2013">
          ...
          <Fade right>
            <NavLink to="/premier_partant_trot" className="rubrique border-black">
              <h6 className="titreRubrique">1er partant au trot</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/premier_gagnant_trot" className="rubrique border-black">
              <h6 className="titreRubrique">1er gagnant au trot</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/premiere_place_dieppe" className="rubrique border-black">
              <h6 className="titreRubrique">1ère place à Dieppe</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/premier_gagnant_dieppe" className="rubrique border-black">
              <h6 className="titreRubrique">1er gagnant à Dieppe</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/premier_gagnant_vincennes" className="rubrique border-black">
              <h6 className="titreRubrique">1er gagnant à Vincennes</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/auteur2014" className="rubrique border-white">
              <h6 className="titreRubrique">Auteur</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/baldi_star" className="rubrique border-white">
              <h6 className="titreRubrique">Baldi Star</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/borsalino_du_jal" className="rubrique border-white">
              <h6 className="titreRubrique">Borsalino du Jal</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/claudia_eria" className="rubrique border-white">
              <h6 className="titreRubrique">Claudia Eria</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/kilava" className="rubrique border-white">
              <h6 className="titreRubrique">Kilava</h6>
            </NavLink>
          </Fade>
          <Fade right>
            <NavLink to="/magic_miles" className="rubrique border-white">
              <h6 className="titreRubrique">Magic Miles</h6>
            </NavLink>
          </Fade>

          <Fade right>
            <NavLink to="/unrefundable2014" className="rubrique border-white">
